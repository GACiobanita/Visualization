import unittest
from implementation.barchart_generator import BarChartGenerator
...
class Test_BarChart(unittest.TestCase):
    ...
    def test_create_horizontal_bar_chart_valid(self):
        ...
        {'0-50': 1, '51-100': 9, '101-200': 11, '201-300': 25, '301-400': 60,
         '400+': 5}, {'0-50': 1, '51-100': 9, '101-200': 11, '201-300': 25, '301-400': 60,
                      '400+': 5}, {'0-50': 1, '51-100': 9, '101-200': 11, '201-300': 25, '301-400': 60,
                                   '400+': 5})
        self.barchart_generator.create_overall_bar_charts()
        self.barchart_generator.show_bar_charts()

    def test_create_horizontal_bar_chart_invalid(self):
        self.barchart_generator.total_word_count = {'0-50': "invalid", '51-100': 9, '101-200': 11, '201-300': 25, '301-400': 60,
                                                    '400+': 5}
        self.barchart_generator.per_file_word_count = (
            {'0-50': 1, '51-100': 9, '101-200': 11, '201-300': 25, '301-400': 60,
             '400+': 5}, {'0-50': 1, '51-100': 9, '101-200': 11, '201-300': 25, '301-400': 60,
